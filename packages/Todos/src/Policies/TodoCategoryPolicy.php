...
namespace Stpronk\Todos\Policies;
...
class TodoCategoryPolicy
{
    ...
    public function view(AuthUser $authUser, TodoCategory $category): bool
    {
    ...
    public function update(AuthUser $authUser, TodoCategory $category): bool
    {
        return $authUser->can('Update:TodoCategory');
    }

    public function delete(AuthUser $authUser, TodoCategory $category): bool
    {
        return $authUser->can('Delete:TodoCategory');
    }

    public function restore(AuthUser $authUser, TodoCategory $category): bool
    {
        return $authUser->can('Restore:TodoCategory');
    }

    public function forceDelete(AuthUser $authUser, TodoCategory $category): bool
    {
    ...
    public function replicate(AuthUser $authUser, TodoCategory $category): bool
    {
